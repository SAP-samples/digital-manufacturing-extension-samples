sap.ui.define([
    ...
    var oLogger = Logging.getLogger("sap.ext.exampleplugins.exampleWip.util.NetworkGraphLoader");

    var NetworkGraphLoader = BaseObject.extend("sap.ext.exampleplugins.exampleWip.util.NetworkGraphLoader", {

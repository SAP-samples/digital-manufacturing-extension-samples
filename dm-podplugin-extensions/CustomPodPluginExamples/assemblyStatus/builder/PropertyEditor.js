sap.ui.define([
    ...
    "use strict";
    var oFormContainer;
    return PropertyEditor.extend( "sap.ext.exampleplugins.assemblyStatus.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("sap.ext.exampleplugins.assemblyStatus.i18n.builder");
			this.setPluginResourceBundleName("sap.ext.exampleplugins.assemblyStatus.i18n.i18n");
		},

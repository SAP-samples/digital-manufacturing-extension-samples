sap.ui.define([
    ...
    "use strict";
    var oFormContainer;
    return PropertyEditor.extend( "com.custom.plugins.scanassembly.scanassemblyapp.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("com.custom.plugins.scanassembly.scanassemblyapp.i18n.builder");
			this.setPluginResourceBundleName("com.custom.plugins.scanassembly.scanassemblyapp.i18n.i18n");
		},

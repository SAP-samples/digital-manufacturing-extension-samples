		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapdmdmeauditlogs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdmdmeauditlogs-display": {
								"semanticObject": "sapdmdmeauditlogs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.dm.dme.auditlogs",
									"url": sap.ui.require.toUrl("sap/dm/dme/auditlogs")
								}
							}
						}
					}

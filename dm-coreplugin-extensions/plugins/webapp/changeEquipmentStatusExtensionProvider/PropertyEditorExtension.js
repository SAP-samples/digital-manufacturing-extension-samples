sap.ui.define([
    ...
    return PluginPropertyEditorExtension.extend("sap.example.plugins.changeEquipmentStatusExtensionProvider.PropertyEditorExtension", {
        ...
        addPropertyEditorContentAfter: function (oPropertyFormContainer, oPropertyData) {
            ...
            let aControls = [
                {
                    control: oPropertyEditor.addSwitch(oPropertyFormContainer, "confirmStatusChange", oPropertyData),
                    label: "Confirm before changing equipment status"
                },
                {
                    control: oPropertyEditor.addSwitch(oPropertyFormContainer, "logToConsole", oPropertyData),

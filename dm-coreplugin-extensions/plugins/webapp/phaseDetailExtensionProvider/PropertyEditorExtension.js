sap.ui.define([
    ...
    return PluginPropertyEditorExtension.extend("sap.example.plugins.phaseDetailExtensionProvider.PropertyEditorExtension", {
        ...
        addPropertyEditorContentBefore: function (oPropertyFormContainer, oPropertyData) {
            ...
            if (oPropertyEditor) {
                ...
                oSwitch = oPropertyEditor.addSwitch(oPropertyFormContainer, "showInspectionRequired", oPropertyData);
                iIndex = oPropertyFormContainer.indexOfContent(oSwitch);
                aContent = oPropertyFormContainer.getContent();
                if (aContent[iIndex-1].setText) {
                    oLabel = aContent[iIndex-1];
                    oLabel.setText("Show Inspection Required");
                }
            }
        },
        ...
        addPropertyEditorContentAfter: function (oPropertyFormContainer, oPropertyData) {
            this._oExtensionUtilities.logMessage("PropertyEditorExtension.addPropertyEditorContentAfter: Phase Detail extension");
            return;
        },
        ...
        getPropertyData: function (oPropertyData) {
            ...
            if (typeof oPropertyData.showInspectionRequired === "undefined") {
                oPropertyData.showInspectionRequired = true;
            }
        ...
        setPropertyData: function (oPropertyData) {
            this._oExtensionUtilities.logMessage("PropertyEditorExtension.setPropertyData: Phase Detail extension");
            if (typeof oPropertyData.logToConsole === "undefined") {
                oPropertyData.logToConsole = false;
            }
            if (typeof oPropertyData.showHelp === "undefined") {

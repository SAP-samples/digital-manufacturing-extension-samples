sap.ui.define([
    ...
    return PluginPropertyEditorExtension.extend("sap.example.plugins.lineMonitorOrderSummaryExtensionProvider.PropertyEditorExtension", {
        ...
        addPropertyEditorContentAfter: function (oPropertyFormContainer, oPropertyData) {
            ...
            const aExtensionModeValues = [
                "MODIFY",
                "REPLACE"
            ];
            const aExtensionModeLabels = [
                "Modify default card",
                "Replace card view"
            ];
            this._oExtensionMode = this.getController().addSelect(oPropertyFormContainer, "extensionMode", oPropertyData, aExtensionModeValues, aExtensionModeLabels, true);

            const aControls = [
                {
                    control: this._oExtensionMode,
                    label: "Sample extension behavior"
                },
                {

 sap.ui.define([
    ...
    "sap/example/plugins/lineMonitorOrderSummaryExtensionProvider/LifecycleExtension",
    "sap/example/plugins/lineMonitorOrderSummaryExtensionProvider/PluginEventExtension",
    "sap/example/plugins/lineMonitorOrderSummaryExtensionProvider/PropertyEditorExtension",
    "sap/example/plugins/lineMonitorOrderSummaryExtensionProvider/ExtensionUtils",
    ...
    return PluginExtensionProvider.extend("sap.example.plugins.lineMonitorOrderSummaryExtensionProvider.ExtensionProvider", {

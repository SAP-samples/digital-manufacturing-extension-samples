sap.ui.define([
    ...
    return PluginControllerExtension.extend("sap.example.plugins.lineMonitorShiftProgressExtensionProvider.LifecycleExtension", {
        ...
        onBeforeRendering: function(oEvent) {
            ...
            this._oExtensionUtilities.logMessage("LifecycleExtension.onBeforeRendering: LineMonitorShiftProgress extension");
        },

        onBeforeRenderingPlugin: function(oEvent) {
            this._oExtensionUtilities.logMessage("LifecycleExtension.onBeforeRenderingPlugin: LineMonitorShiftProgress extension");
        },

        onAfterRendering: function(oEvent) {
            this._oExtensionUtilities.logMessage("LifecycleExtension.onAfterRendering: LineMonitorShiftProgress extension");
        },

        onExit: function(oEvent) {
            this._oExtensionUtilities.logMessage("LifecycleExtension.onExit: LineMonitorShiftProgress extension");
        }
    })
});

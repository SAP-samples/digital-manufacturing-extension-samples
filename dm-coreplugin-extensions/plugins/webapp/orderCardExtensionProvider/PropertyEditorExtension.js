sap.ui.define([
    ...
    return PluginPropertyEditorExtension.extend("sap.example.plugins.orderCardExtensionProvider.PropertyEditorExtension", {
        ...
        addPropertyEditorContentAfter: function (oPropertyFormContainer, oPropertyData) {
            this._oExtensionUtilities.logMessage("PropertyEditorExtension.addPropertyEditorContentAfter: Order Card extension");
            return;
        },
        ...
        setPropertyData: function (oPropertyData) {
            this._oExtensionUtilities.logMessage("PropertyEditorExtension.setPropertyData: Order Card extension");
            if (typeof oPropertyData.logToConsole === "undefined") {
                oPropertyData.logToConsole = false;
            }
            if (typeof oPropertyData.showHelp === "undefined") {

sap.ui.define([
    ...
    "sap/dm/dme/oeetransactionplugins/speedLossOrderListPlugin/controller/extensions/PluginEventExtensionConstants",
    ...
    return PluginControllerExtension.extend("sap.example.plugins.speedlossExtensionProvider.PluginEventExtension", {
        ...
        onGetReasonCodeDialogFragment: function(sId, sFragment, oContext) {
            ...
            return Fragment.load({
                id: sId,
                name: "sap.example.plugins.speedlossExtensionProvider.fragment.CustomReasonCodeDialog",
                controller: this
            });
        },

sap.ui.define([
    ...
    "sap/ext/exampleplugins/exampleWipPlugin/util/NetworkGraphLoader"
    ...
    PluginViewController.extend("sap.ext.exampleplugins.exampleWipPlugin.controller.PluginView", {
        onInit: function () {
        ...
        openOrderDetail: function (oNode, oButton) {
            ...
            var that = this;
            if (!this._oQuickOrderView) {
                var sFragment = "sap.ext.exampleplugins.exampleWipPlugin.view.fragments.OrderFragment";
        ...
        openSfcDetail: function (oNode, oButton) {
            ...
            var that = this;
            if (!this._oQuickSfcView) {
                var sFragment = "sap.ext.exampleplugins.exampleWipPlugin.view.fragments.SfcFragment";

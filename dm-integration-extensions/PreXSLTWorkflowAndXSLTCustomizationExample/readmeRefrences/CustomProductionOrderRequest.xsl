...
<xsl:stylesheet version="2.0"
		...
		<ManufacturingOrder>
			...
			<xsl:if test="E1AFLTH">
				<LongText pp:MIMECode="application/json" pp:TextCategory="{E1AFLTH[1]/TDTEXTTYPE}">
					...
					<xsl:for-each select="E1AFLTH[1]/E1AFLTP">{"TDFORMAT":"
						
						<xsl:value-of select="TDFORMAT"/>","TDLINE":"
			...
			<CustomFieldList>
				<CustomField>
					...
					<Value>
						<xsl:value-of select="E1AFPOL/KDAUF"/>
					</Value>
				</CustomField>
				<CustomField>
					<Attribute>CD_ACTIVITY_ID</Attribute>
					<Value>
						<xsl:value-of select="E1AFFLL/E1AFVOL[1]/VORNR"/>
					</Value>
				</CustomField>
				<CustomField>
				...
				<CustomField>
					...
					<Value>
						<xsl:value-of select="E1AFPOL/NAME1"/>
					</Value>
				</CustomField>
				<CustomField>
					<xsl:variable name="CONFHIS1" select="/*/IDOC/E1AFKOL/ZCONFHIST1"/>
					<Attribute>CONFIRMATIONHISTORY1</Attribute>
					<xsl:choose>
						<xsl:when test="$CONFHIS1 != '' ">
							<Value>
								<xsl:value-of select="/*/IDOC/E1AFKOL/ZCONFHIST1"/>
							</Value>
						</xsl:when>
						<xsl:otherwise>
							<Value>[]</Value>
				...
				<CustomField>
					<xsl:variable name="CONFHIS2" select="/*/IDOC/E1AFKOL/ZCONFHIST2"/>
					<Attribute>CONFIRMATIONHISTORY2</Attribute>
					<xsl:choose>
						<xsl:when test="$CONFHIS2 != '' ">
							<Value>
								<xsl:value-of select="$CONFHIS2"/>
							</Value>
						</xsl:when>
						<xsl:otherwise>
							<Value>[]</Value>
			...
			<!-- Sample for custom field on order bom header level -->
			<!--
            <BomHeaderCustomFieldList><CustomField><Attribute>XYZ</Attribute><Value>value_1</Value></CustomField><CustomField><Attribute>ABC</Attribute><Value>value_1</Value></CustomField></BomHeaderCustomFieldList>
            -->
			...
			<!-- Sample to customizing quantity validation flag on routing -->
			<!--
            <QuantityValidation><xsl:value-of select="false()"/></QuantityValidation>
            -->
			<!-- Sample to set QuantityToRelease to indicate how many quantity should be released after order is downloaded -->
			<!--
            <QuantityToRelease>all</QuantityToRelease>
            -->
		</ManufacturingOrder>
		<!-- Work Instruction -->
									...
									<xsl:when test="../RSPOS">
										<bomComponentRef>
											<bomDTO>
												<bom>
													<!--
                                                    <xsl:call-template name="addBomName"><xsl:with-param name="material" select="/*/IDOC/E1AFKOL/MATNR"/><xsl:with-param name="materialExt"
                                                            select="/*/IDOC/E1AFKOL/MATNR_EXTERNAL"/><xsl:with-param name="materialLong"
                                                            select="/*/IDOC/E1AFKOL/MATNR_LONG"/><xsl:with-param name="usage" select="/*/IDOC/E1AFKOL/STLAN"/><xsl:with-param name="altBom" select="/*/IDOC/E1AFKOL/STLAL"/></xsl:call-template>
                                                    -->
													<xsl:value-of select="AUFNR"/>
												</bom>
												<bomType>U</bomType>
		...
		<xsl:for-each select="E1AFVOL[E1JSTVL[last()]/STAT!='I0013']">
			<ManufacturingOrderActivityNetworkElement>
				...
				<xsl:for-each select="E1RESBL">
					<pp:ManufacturingOrderComponent>
						...
						<!--
                        <ZMaximumToleranceInPct>11.123</ZMaximumToleranceInPct><ZMinimumToleranceInPct>10.123</ZMinimumToleranceInPct>
                        -->
						<!-- Sample for custom field on component level -->
						<!--
                        <CustomFieldList><CustomField><Attribute>XYZ</Attribute><Value>value_1</Value></CustomField><CustomField><Attribute>ABC</Attribute><Value>value_1</Value></CustomField></CustomFieldList>
                        -->
						<xsl:for-each select="E1STPUL">
							<ZBOMSubItem>
								<ZBOMSubItemNumberValue>
									<xsl:value-of select="UPOSZ"/>
								</ZBOMSubItemNumberValue>
								<ZBOMSubItemInstallationPoint>
									<xsl:value-of select="EBORT"/>
								</ZBOMSubItemInstallationPoint>
								<ZBillOfMaterialSubItemText>
									<xsl:value-of select="UPTXT"/>
								</ZBillOfMaterialSubItemText>
								<ZBillOfMaterialSubItemQuantity>
									<xsl:value-of select="UPMNG"/>
								</ZBillOfMaterialSubItemQuantity>
							</ZBOMSubItem>
						</xsl:for-each>
					</pp:ManufacturingOrderComponent>
                ...
                Please be aware that changing of Operation Activity Resource Type may affect processing of active SFCs -->
				<!--
			...
			<xsl:for-each select="E1AFUVL[E1JSTUL[last()]/STAT!='I0013']">
				<ManufacturingOrderActivityNetworkElement>
                    ...
                    <pp:WorkCenter><xsl:value-of select="ARBPL" /></pp:WorkCenter>
                    -->
					<pp:WorkCenterInternalID>
						<xsl:value-of select="ARBID" />
					</pp:WorkCenterInternalID>
					...
					<pp:OperationControlProfile pp:OperationControlKey="{STEUS}">
                        ...
                        <pp:CompletionConfirmation pp:CompletionConfirmationCode="{RUEK}"><ConfirmationIsMilestoneConf><xsl:choose><xsl:when test="RUEK='1'"><xsl:value-of select="true()" /></xsl:when><xsl:otherwise><xsl:value-of select="false()" /></xsl:otherwise></xsl:choose></ConfirmationIsMilestoneConf><ConfirmationIsRequired><xsl:choose><xsl:when test="RUEK='2'"><xsl:value-of select="true()" /></xsl:when><xsl:otherwise><xsl:value-of select="false()" /></xsl:otherwise></xsl:choose></ConfirmationIsRequired><ConfirmationIsNotPossible><xsl:choose><xsl:when test="RUEK='3'"><xsl:value-of select="true()" /></xsl:when><xsl:otherwise><xsl:value-of select="false()" /></xsl:otherwise></xsl:choose></ConfirmationIsNotPossible><ConfirmationIsOptional><xsl:choose><xsl:when test="RUEK=(' ','0','') or empty(RUEK)"><xsl:value-of select="true()" /></xsl:when><xsl:otherwise><xsl:value-of select="false()" /></xsl:otherwise></xsl:choose></ConfirmationIsOptional></pp:CompletionConfirmation>
                        -->
						<!-- Sub-Operation doesn't have E1AFVOL2 section
                        <pp:OperationIsScheduled><xsl:call-template name="convertToBool"><xsl:with-param name="bool" select="E1AFVOL2/TERM" /></xsl:call-template></pp:OperationIsScheduled><pp:CapacityRequirementsAreDtmnd><xsl:call-template name="convertToBool"><xsl:with-param name="bool" select="E1AFVOL2/KAPA" /></xsl:call-template></pp:CapacityRequirementsAreDtmnd><pp:GRIsPostedAutomatically><xsl:call-template name="convertToBool"><xsl:with-param name="bool" select="E1AFVOL2/AUTWE" /></xsl:call-template></pp:GRIsPostedAutomatically><pp:OperationIsNotMESRelevant><xsl:call-template name="convertToBool"><xsl:with-param name="bool" select="E1AFVOL2/NOT_MES_REL" /></xsl:call-template></pp:OperationIsNotMESRelevant>
                        -->
					</pp:OperationControlProfile>
					<pp:StandardWorkFormulaParamGroup StandardWorkFormulaParamGroupID="{VGWTS}">
						<xsl:if test="VGE01 != ''">
							<WorkCenterFormulaParam1 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR01_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE01}">
									<xsl:value-of select="VGW01" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM1}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY1" /></ToBeConfirmedTotalWorkQty>
                                -->
							</WorkCenterFormulaParam1>
						</xsl:if>
						<xsl:if test="VGE02 != ''">
							<WorkCenterFormulaParam2 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR02_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE02}">
									<xsl:value-of select="VGW02" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM2}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY2" /></ToBeConfirmedTotalWorkQty>
                                 -->
							</WorkCenterFormulaParam2>
						</xsl:if>
						<xsl:if test="VGE03 != ''">
							<WorkCenterFormulaParam3 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR03_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE03}">
									<xsl:value-of select="VGW03" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM3}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY3" /></ToBeConfirmedTotalWorkQty>
                                -->
							</WorkCenterFormulaParam3>
						</xsl:if>
						<xsl:if test="VGE04 != ''">
							<WorkCenterFormulaParam4 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR04_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE04}">
									<xsl:value-of select="VGW04" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM4}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY4" /></ToBeConfirmedTotalWorkQty>
                                -->
							</WorkCenterFormulaParam4>
						</xsl:if>
						<xsl:if test="VGE05 != ''">
							<WorkCenterFormulaParam5 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR05_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE05}">
									<xsl:value-of select="VGW05" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM5}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY5" /></ToBeConfirmedTotalWorkQty>
                                -->
							</WorkCenterFormulaParam5>
						</xsl:if>
						<xsl:if test="VGE06 != ''">
							<WorkCenterFormulaParam6 WorkCenterFormulaParamID="">
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <StandardWorkFormulaParamName languageCode=""><xsl:value-of select="E1AFVOL2/PAR06_LTXT" /></StandardWorkFormulaParamName>
                                -->
								<WorkCenterStandardWorkQty pp:unitCode="{VGE06}">
									<xsl:value-of select="VGW06" />
								</WorkCenterStandardWorkQty>
								...
								<!-- Sub-Operation doesn't have E1AFVOL2 section
                                <ToBeConfirmedTotalWorkQty pp:unitCode="{E1AFVOL2/TO_BE_CONF_ACT_UOM6}"><xsl:value-of select="E1AFVOL2/TO_BE_CONF_ACTIVITY6" /></ToBeConfirmedTotalWorkQty>
                                -->
							</WorkCenterFormulaParam6>
						</xsl:if>
					</pp:StandardWorkFormulaParamGroup>
	...
	<xsl:template name="getMaterial">
		...
		<xsl:variable name="materialMask">
			<xsl:choose>
				<xsl:when test="string-length($materialString) > 18">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:value-of select="format-number(xs:decimal($materialString), $materialMask)"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
